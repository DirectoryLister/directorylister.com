<div class="bg-blue-700 text-white bg-gradient-to-r from-blue-700 via-indigo-600 to-indigo-700">
    <div class="container max-w-4xl mx-auto px-4 py-12 flex flex-col justify-center items-center sm:flex-row lg:px-0">
