    ...
    <div class="container max-w-4xl mx-auto px-4 py-12 flex flex-col justify-between items-center text-center lg:px-0">
        <div>
            @foreach ($release->assets as $asset)
                <a href="{{ $asset->browser_download_url }}" data-umami-event="download" data-umami-event-version="{{ $release->tag_name }}" data-umami-event-asset="{{ $asset->name }}" data-umami-event-content-type="{{ $asset->content_type }}"
